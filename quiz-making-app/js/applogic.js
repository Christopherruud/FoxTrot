...
/**
 * 
 * @param domain the name of the area (domain) the course represents. Acts as the name of the course.
 */
...
/**
 * 
 * @param courseId the ID of the course this module belongs to
 */
...
/**
 * 
 * @param moduleId the ID of the module this course belongs to
 */
...
function populateCourseData(json) {
	$('#courseTable').empty(); //empties the coursedata -table before initializing
