        ...
        $("#add").click(
            function () {
                $("#table1").append(
                    ...
                    + '</td><td width="200px">'
                    + ("none")
                    + '</td><td width="100px" align="center"> <a href="javascript:void(0);" class="remCF">Remove</a></td><td width="100px" align="center"><a href="moduleedit.html?course='+ currentId + '">Create modules</a></td></tr>');
