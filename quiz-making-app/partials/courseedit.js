...
/* Js 2 - denne koden fungere for en eller annen grunn ikke, men snakker med html skjema 2 courseedit.html
 * 
$(function () {
	...
	var $domain = $('#domain');
	var $level = $('level');
	var $descriptiveText = $('descriptiveText');
	var $module = $('module');
    
    var courseTemplate = $('#course-template').html();
	
	function addCourse(course){
        $courses.append(Mustache.render(courseTemplate, order));
    }
    ...
    $('#add-course').on('click', function() {
        ...
        var course ={
            ...
            domain: $domain.val(),
            level: $level.val(),
            descriptiveText: $descriptiveText.val(),
            module: $module.val(),
        };
    ...
    $courses.delegate('.remove', 'click', function(){
        ...
        $.ajax({
            type: 'DELETE',
            url: '/api/systemSettings/quizTestKey' + $(this).attr('data-id'),
            success: function (){
